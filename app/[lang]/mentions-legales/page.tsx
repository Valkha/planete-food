...
export const metadata: Metadata = {
  ...
  description: `Informations légales, conditions générales de vente et politique de confidentialité de ${restaurantConfig.name}.`,
};
  ...
  return (
    <div className="bg-neutral-900 min-h-screen text-gray-300 py-24">
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <h1 className="text-4xl font-display font-bold text-white mb-12 border-l-4 border-brand-primary pl-6">
        ...
        <div className="space-y-12">
          ...
          <section className="bg-neutral-800 p-8 rounded-2xl border border-neutral-700">
            ...
            <p className="mb-4">
              Le site internet <strong>{restaurantConfig.name}</strong> est édité par :
            </p>
            <ul className="list-disc pl-5 space-y-2 text-white">
              <li><strong>Raison sociale :</strong> {restaurantConfig.name} (À adapter)</li>
              {restaurantConfig.address && restaurantConfig.address !== "[Adresse du restaurant]" && (
                <li><strong>Adresse :</strong> {restaurantConfig.address}</li>
              )}
              {restaurantConfig.phone && (
                <li><strong>Téléphone :</strong> {restaurantConfig.phone}</li>
              )}
              {restaurantConfig.email && (
                <li><strong>Email :</strong> {restaurantConfig.email}</li>
              )}
              <li><strong>Numéro IDE (UID) :</strong> [À compléter]</li>
          ...
          <section>
            ...
            <div className="space-y-4 leading-relaxed">
              ...
              <p><strong>Livraison :</strong> {restaurantConfig.name} s&apos;efforce de respecter les horaires de livraison et de retrait annoncés. Toutefois, un retard indépendant de notre volonté (trafic, intempéries) ne donne droit à aucune compensation. Il incombe au client de fournir une adresse et un numéro de téléphone exacts.</p>
            </div>
          </section>

          {/* SECTION 3 : DONNÉES PERSONNELLES & PAIEMENTS */}
          <section>
            <h2 className="text-xl font-bold text-white mb-4">3. Protection des Données et Paiements</h2>
            <div className="space-y-4 leading-relaxed">
              <p>
                {restaurantConfig.name} s&apos;engage à ce que la collecte et le traitement de vos données (nom, adresse, téléphone) soient conformes à la loi fédérale sur la protection des données (LPD). Elles sont conservées uniquement pour la gestion de vos commandes et notre service client.
              </p>
              <p className="p-4 bg-brand-primary/10 border border-brand-primary/20 rounded-xl text-white">
                <strong>Sécurité des paiements :</strong> Vos transactions financières sont entièrement gérées et sécurisées par notre partenaire <strong>Stripe Inc.</strong> {restaurantConfig.name} ne stocke, ni n&apos;a accès à aucun moment à vos coordonnées bancaires complètes.
              </p>
            </div>
          </section>
